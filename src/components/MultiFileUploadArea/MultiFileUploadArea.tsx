  ...
  return (
    <div
      ...
      <div className={css(styles.multipleFileUploadTitle)}>
        <div className={css(styles.multipleFileUploadTitleIcon)}>
          {titleIcon}
        </div>
        <div className={css(styles.multipleFileUploadTitleText)}>
          {titleText}
        </div>
      </div>
      ...
      <div className={css(styles.multipleFileUploadUpload)} style={{ gridArea: 'upload2', gridRowStart: 1, gridRowEnd: 'span 2', display: 'flex', alignItems: 'center'}}>
        <Button variant="secondary" onClick={open}>
          {uploadText}
        </Button>
      </div>
      <div className={css(styles.multipleFileUploadInfo)}>
        {infoText}
      </div>
    </div>
